...
Make sure that the background size is much bigger than screen size to allow for some scrolling. [View example](http://lab.hakim.se/reveal-js/?parallaxBackgroundImage=https://s3.amazonaws.com/hakim-static/reveal-js/reveal-parallax-1.jpg&parallaxBackgroundSize=2100px%20900px).
