...
- 🦙 [My Agentic Coding Rules, Custom Agents and Workflows](https://github.com/sammcj/agentic-coding/)
...
- [Claude Code](https://www.claude.com/product/claude-code) - The best (equal) Agentic Coding tool
- [Cline](https://cline.bot) - The best (equal) Agentic Coding tool
...
- [Llama.cpp](https://github.com/ggml-org/llama.cpp) - LLM Model Server
- [LlamaSwap](https://github.com/mostlygeek/llama-swap) - Automatic llama.cpp model serving and swapping
...
- [Feeeed](https://feeeed.nateparrott.com/) - Excellent RSS Client with a lot of smarts
...
- [LLMFeeder](github.com/jatinkrmalik/LLMFeeder) - Copies web pages as markdown for LLMs
- [Refined Github](https://github.com/refined-github/refined-github) - Improve GitHub
